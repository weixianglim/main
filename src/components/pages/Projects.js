...
{ 
    ...
    const [arrCardsRest, ] = useState(
        [
            ...
            {src: FishieeTn, desc: "Fishie Protecc is a fast-paced game which will strain the players reaction speeds and planning abilities. You have to possess other fishes within the vicinity to get them out of harm's way. As the game progresses, special fishies will also be available which you can possess and use to destroy or hinder hazards.", label: "FishieeProtecc", linkTo: "/fishieprotecc"}
        ]
    );
