...
{ 
    ...
    const [arrCardsRest, ] = useState(
        [
            {src: ApotcalypseTn, desc: "Apotcalypse is a colony simulator built on a custom 3D engine whereby the player has to manage a very crucial resource - Frulets! These cute bubbly creatures are indispensable and are necessary to stop the impending Apotcalypse.", label: "Apotcalypse", linkTo: "/projects"},   
            {src: FishieeTn, desc: "FishieProtecc is a fast-paced game which will strain the players reaction speeds and planning abilities. It is my freshman project in DigiPen and was nominated for Gumi Asia's Best Freshman Game award.", label: "FishieeProtecc", linkTo: "/projects"},   
            {src: IllanTn, desc: "Illan: Shades of Memories is a 3D exploration game made in Unity Engine and is developed with the PS4 in mind as it's primary intended target platform.", label: "Illan: Shades of Memories", linkTo: "/projects"}               
        ]
    );
